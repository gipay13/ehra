					...
					<div class="card-body">
						<div class="form-group">
							...
							<select name="laporan" id="laporan" class="form-control">
								<option value="amati_ao">Amati Dapur dan Sekelilingnya</option>
								<option value="amati_bo">Amati Kamar Mandi</option>
								<option value="amati_co">Amati Jamban</option>
								<option value="amati_do">Amati Tempat Cuci Pakaian</option>
								<option value="amati_eo">Amati Sekitar Rumah</option>
							</select>
						</div>
						<div class="form-group">
