					...
					<div class="card mt-2" id="card-b">
						...
						<div id="<?= $k->kode_kategori ?>" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
							<div class="card-body">
								...
								<button type="button" id="to-c" class="btn btn-info btn-next">Next</button>
							</div>
						</div>
					</div>
				<?php } ?>
				<?php
				foreach ($kategoriC as $k) { ?>
					<div class="card mt-2" id="card-c">
						...
						<div id="<?= $k->kode_kategori ?>" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
							<div class="card-body">
								...
								<button type="button" id="to-b" class="btn btn-warning btn-prev">Back</button>
								<button type="button" id="to-d" class="btn btn-info btn-next">Next</button>
							</div>
						</div>
					</div>
				<?php } ?>
					...
					<div class="card mt-2" id="card-d">
						...
						<div id="<?= $k->kode_kategori ?>" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
							<div class="card-body">
								...
								<button type="button" id="to-c" class="btn btn-warning btn-prev">Back</button>
								<button type="button" id="to-e" class="btn btn-info btn-next">Next</button>
							</div>
						</div>
					</div>
				<?php } ?>
					...
					<div class="card mt-2" id="card-e">
						...
						<div id="<?= $k->kode_kategori ?>" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
							<div class="card-body">
								...
								<button type="button" id="to-d" class="btn btn-warning btn-prev">Back</button>
								<button type="button" id="to-f" class="btn btn-info btn-next">Next</button>
							</div>
						</div>
					</div>
				<?php } ?>
					...
					<div class="card mt-2" id="card-f">
						...
						<div id="<?= $k->kode_kategori ?>" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
							<div class="card-body">
								...
								<button type="button" id="to-e" class="btn btn-warning btn-prev">Back</button>
								<button type="button" id="to-g" class="btn btn-info btn-next">Next</button>
							</div>
						</div>
					</div>
				<?php } ?>
					...
					<div class="card mt-2" id="card-g">
						...
						<div id="<?= $k->kode_kategori ?>" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
							<div class="card-body">
								...
								<button type="button" id="to-f" class="btn btn-warning btn-prev">Back</button>
								<button type="button" id="to-h" class="btn btn-info btn-next">Next</button>
							</div>
						</div>
					</div>
				<?php } ?>
					...
					<div class="card mt-2" id="card-h">
						...
						<div id="<?= $k->kode_kategori ?>" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
							<div class="card-body">
								...
								<button type="button" id="to-g" class="btn btn-warning btn-prev">Back</button>
								<button type="button" id="to-ao" class="btn btn-info btn-next">Next</button>
							</div>
						</div>
					</div>
				<?php } ?>
					...
					<div class="card mt-2" id="card-ao">
						...
						<div id="<?= $k->kode_kategori ?>" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
							<div class="card-body">
								...
								<button type="button" id="to-h" class="btn btn-warning btn-prev">Back</button>
								<button type="button" id="to-bo" class="btn btn-info btn-next">Next</button>
							</div>
						</div>
					</div>
				<?php } ?>
					...
					<div class="card mt-2" id="card-bo">
						...
						<div id="<?= $k->kode_kategori ?>" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
							<div class="card-body">
								...
								<button type="button" id="to-ao" class="btn btn-warning btn-prev">Back</button>
								<button type="button" id="to-co" class="btn btn-info btn-next">Next</button>
							</div>
						</div>
					</div>
				<?php } ?>
					...
					<div class="card mt-2" id="card-co">
						...
						<div id="<?= $k->kode_kategori ?>" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
							<div class="card-body">
								...
								<button type="button" id="to-bo" class="btn btn-warning btn-prev">Back</button>
								<button type="button" id="to-do" class="btn btn-info btn-next">Next</button>
							</div>
						</div>
					</div>
				<?php } ?>
					...
					<div class="card mt-2" id="card-do">
						...
						<div id="<?= $k->kode_kategori ?>" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
							<div class="card-body">
								...
								<button type="button" id="to-co" class="btn btn-warning btn-prev">Back</button>
								<button type="button" id="to-eo" class="btn btn-info btn-next">Next</button>
							</div>
						</div>
					</div>
				<?php } ?>
					...
					<div class="card mt-2" id="card-eo">
						...
						<div id="<?= $k->kode_kategori ?>" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
							<div class="card-body">
								...
								<button type="button" id="to-do" class="btn btn-warning btn-prev">Back</button>
