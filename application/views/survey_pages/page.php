									...
									foreach ($data as $p) { ?>
										<tr>
											...
											<td class="col-md-5">
												...
												<?php if ($p->id == 1) { ?>
													<div class="ml-1">
														<input type="text" class="col-md-8 form-control" name="answer<?= $p->id; ?>" placeholder="ex. 30 Tahun">
													</div>
												<?php } ?>
												<?php if ($p->id == 2) { ?>
													<div>
												...
												<?php if ($p->id == 3) { ?>
													<div class="ml-1">
														<input type="text" class="form-control col-md-7" name="answer<?= $p->id; ?>" placeholder="ex. 100 m2">
													</div>
												<?php } ?>
												<?php if ($p->id == 4) { ?>
													<div>
									...
									foreach ($data as $p) { ?>
										<tr>
											...
											<td class="col-md-5">
												<?php if ($p->id == 15) { ?>
													<div class="ml-1">
														<input type="text" class="form-control col-md-7" name="answer<?= $p->id; ?>" placeholder="ex. 7 Liter">
													</div>
												<?php } ?>
												<?php if ($p->id == 16) { ?>
													<div>
